...
public class Bullet : MonoBehaviour
{
    ...
    private void HandleImpactDamage(RaycastHit hitInfo)
    {
        ...
        {
            healthController = hitInfo.transform.gameObject.GetComponent<HealthController>();
            healthController.health -= damageAmount;
            if (healthController.health < 0) healthController.health = 0;
            if (healthController.OnHealthChanged != null) healthController.OnHealthChanged(this, System.EventArgs.Empty);
        }
    }
